...
"")
        ...
        self.ImagePreview = QtWidgets.QGraphicsView(self.page_3)
        ...
        self.dimsLabel = QtWidgets.QLabel(self.page_3)
        self.dimsLabel.setObjectName("dimsLabel")
        self.horizontalLayout_3.addWidget(self.dimsLabel)
        self.imageDimensionsLabel = QtWidgets.QLabel(self.page_3)
